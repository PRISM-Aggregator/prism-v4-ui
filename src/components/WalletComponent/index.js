        ...
        <DropdownMenuContent className="w-64 mr-6">
          <div className='flex flex-col w-full gap-2 p-2'>
            ...
            <div className='w-full grid grid-cols-3 h-10 border rounded-md overflow-hidden'>
              <div onClick={() => {
                setPrioFee(0.0005);
              }} className={`${priorityFeeOption === 0 ? 'bg-cyan-500 font-bold' : ''} cursor-pointer w-full h-full flex items-center justify-center border-r`}>
                <p className='text-xs'>High</p>
              </div>
              <div onClick={() => {
                setPrioFee(0.002);
              }} className={`${priorityFeeOption === 1 ? 'bg-cyan-500 font-bold' : ''} cursor-pointer w-full h-full flex items-center justify-center border-r`}>
              ...
              }} className={`${priorityFeeOption === 2 ? 'bg-cyan-500 font-bold' : ''} cursor-pointer w-full h-full flex items-center justify-center`}>
            ...
            </div>
            {
              ...
              <div className='w-full relative flex items-center gap-2'>
                ...
                }} className='w-full h-12 border border-cyan-500 rounded-md p-2 font-bold text-sm px-4'/>
