...
export const stateSlice = createSlice({
  ...
  reducers: {
    ...
    setLiquiditySdk: (state, action) => {
      state.liquiditySdk = action.payload;
    },
    setPendingStates: (state, action) => {
      state.pendingStates = action.payload;
    },
    setPrismSdk: (state, action) => {
      state.prismSdk = action.payload;
    },
    ...
    setMarketsV1: (state, action) => {
      state.marketsV1 = action.payload
    },
...
setGeneralStats, setBenchmarkCharts, setMarketsV1, setMarketsV2, setPriorityFee, reloadBalances, setWallet, setTheme, setDex, setClosedOpenOrders, setTopTokens, refreshState } = stateSlice.actions;
