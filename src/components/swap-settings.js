        ...
        <div className="w-full flex flex-col gap-2">
          ...
          <div className="w-full h-14 grid grid-cols-6 divide-x border rounded-sm overflow-hidden items-center">
            <div onClick={() => {
              setSlippage(10)
              setCustomSlippage("")
              }} className={`w-full select-none transition-all cursor-pointer h-full flex ${slippage === 10 ? 'bg-background-over text-cyan-500' : 'text-muted-foreground hover:text-white'} items-center justify-center text-sm font-bold p-1`}>
              0.1%
            </div>
            <div onClick={() => {
              setSlippage(50)
              setCustomSlippage("")
              }} className={`w-full select-none transition-all cursor-pointer h-full flex ${slippage === 50 ? 'bg-background-over text-cyan-500' : 'text-muted-foreground hover:text-white'} items-center justify-center text-sm font-bold p-1`}>
              0.5%
            </div>
            <div onClick={() => {
              setSlippage(100)
              setCustomSlippage("")
              }} className={`w-full select-none transition-all cursor-pointer h-full flex ${slippage === 100 ? 'bg-background-over text-cyan-500' : 'text-muted-foreground hover:text-white'} items-center justify-center text-sm font-bold p-1`}>
              1%
            </div>
            <div onClick={() => {
              setSlippage(500)
              setCustomSlippage("")
            }} className={`w-full select-none transition-all cursor-pointer h-full flex ${slippage === 500 ? 'bg-background-over text-cyan-500' : 'text-muted-foreground hover:text-white'} items-center justify-center text-sm font-bold p-1`}>
              5%
            </div>
