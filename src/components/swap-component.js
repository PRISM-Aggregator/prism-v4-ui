...
export const SwapComponent = ({
  ...
  return <div className="flex flex-col w-svw px-2 md:px-0 md:w-[400px]">
    <div className="w-full hidden md:flex items-center border overflow-hidden justify-between p-4 h-[58px] rounded-sm relative bg-background hover:bg-background-over transition-all">
      <LogoText className="z-10" height={12}/>
    ...
    <div className={`flex border w-full flex-col mt-2 mb-2 gap-2 rounded-md py-2`}>
      ...
      <div className={`w-full relative flex items-center justify-end px-2`}>
        <input 
          ...
          pattern="[0-9]*"
        />
      <div onClick={() => setTokenSearchPopup(0)} className={`flex hover:border-cyan-500 hover:text-cyan-500 transition-all items-center gap-1 bg-background-over p-1 px-2 rounded-sm border cursor-pointer z-10`}>
          {
            fromToken ?
      ...
      <div className={'flex select-none items-center justify-center relative w-full -my-3'}>
        ...
        <div className={'w-[36px] h-[36px] rounded-full border flex items-center justify-center bg-background-over z-10 cursor-pointer hover:border-cyan-500 hover:text-cyan-500'} onClick={() => switchSide()}>
      ...
      <div className={'w-full mt-1 mb-1 relative flex items-center justify-end px-2'}>
        ...
        <div onClick={() => setTokenSearchPopup(1)} className="flex items-center gap-1 bg-background-over p-1 px-2 rounded-sm border hover:border-cyan-500 hover:text-cyan-500 transition-all cursor-pointer z-10">
          {
            toToken ?
...

    {
      ...
      :
      !wallet.connected ?
      <div onClick={() => setVisible(true)} className="w-full h-[58px] rounded-sm bg-cyan-500 flex items-center justify-center cursor-pointer hover:bg-cyan-600">
        <p className="text-lg font-bold text-black">Connect Wallet</p>
      </div>
      :
